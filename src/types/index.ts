...
export type RootStackParamList = {
  // Login: any;
  Cliente: { vendedor: IUser };
  CadastroCliente: undefined;
  Pedido: { cliente: TClienteResponse; vendedor: IUser };
  Financeiro: { cliente: TClienteResponse; vendedor: IUser };
  Painel: { cliente: TClienteResponse; vendedor: IUser };
  Home: any;
  Vendedor: any;
  Despesas: { vendedor: IUser };
  Baixa: { vendedor: IUser };
};
...
export interface IUser {
  ID?: string;
  UltimaAlteracao?: string | Date; // Pode ser usado como Date após parsing
  ...
  Fonecedor?: boolean; // Nota: Possível typo, deveria ser "fornecedor"?
  Representada?: boolean;
  Ramo?: string;
  vendedorPadrao?: string;
  EmailLoginEcommerce?: string;
  Senha?: string;
  Salt?: string;
  Bloqueado: boolean;
  NomePai?: string;
...
export const dataFrete = [
  { nome: "Destinatário", valor: 1 },
  { nome: "Terceiro", valor: 2 },
  { nome: "Sem frete", valor: 9 },
  { nome: "Emitente", valor: 0 },
];
